...
def do_vector3d(pc):
    ...
    # camera in base of the yumi robot
    pcd.transform([[-0.03574006,  0.25250176, -0.96693614,  0.97472942],
                    [ 0.99935674,  0.00616566, -0.03532832,  0.01105978],
                    [-0.00295867, -0.96757679, -0.2525597,   0.2478182 ],
                    [ 0.,          0.,          0.,          1.        ]])
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if command == ord('t'):
            ...
            #--------------------------------------------------------
            # Threshold
            filter = do_passthrough_filter(point_cloud = cloud,name_axis = 'x', min_axis = 0.40, max_axis = 0.90)
