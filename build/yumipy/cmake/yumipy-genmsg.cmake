...
get_filename_component(_filename "/home/casch/catkin_ws/src/yumipy/srv/ROSYumiArm.srv" NAME_WE)
add_custom_target(_yumipy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yumipy" "/home/casch/catkin_ws/src/yumipy/srv/ROSYumiArm.srv" ""
)
...
_generate_srv_cpp(yumipy
  "/home/casch/catkin_ws/src/yumipy/srv/ROSYumiArm.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yumipy)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yumipy\")")
  # install generated code
  install(
