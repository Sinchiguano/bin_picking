...
class Robotiq3FGripper_robot_input {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Robotiq3FGripper_robot_input(null);
  ...
  static datatype() {
    ...
    return 'robotiq_3f_gripper_control/Robotiq3FGripper_robot_input';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Robotiq3FGripper_robot_input(null);
...
module.exports = Robotiq3FGripper_robot_input;
