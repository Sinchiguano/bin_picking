...
// (in-package robotiq_3f_gripper_control.msg)
...
class Robotiq3FGripper_robot_output {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Robotiq3FGripper_robot_output(null);
  ...
  static datatype() {
    ...
    return 'robotiq_3f_gripper_control/Robotiq3FGripper_robot_output';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Robotiq3FGripper_robot_output(null);
...
module.exports = Robotiq3FGripper_robot_output;
