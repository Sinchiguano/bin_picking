...
(cl:defclass <Robotiq3FGripper_robot_output> (roslisp-msg-protocol:ros-message)
  ((rACT
    :reader rACT
    :initarg :rACT
    :type cl:fixnum
...
(cl:defclass Robotiq3FGripper_robot_output (<Robotiq3FGripper_robot_output>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Robotiq3FGripper_robot_output>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Robotiq3FGripper_robot_output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotiq_3f_gripper_control-msg:<Robotiq3FGripper_robot_output> is deprecated: use robotiq_3f_gripper_control-msg:Robotiq3FGripper_robot_output instead.")))

(cl:ensure-generic-function 'rACT-val :lambda-list '(m))
(cl:defmethod rACT-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rMOD-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rGTO-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rATR-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rGLV-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rICF-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rICS-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rPRA-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rSPA-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rFRA-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rPRB-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rSPB-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rFRB-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rPRC-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rSPC-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rFRC-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rPRS-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rSPS-val ((m <Robotiq3FGripper_robot_output>))
...
(cl:defmethod rFRS-val ((m <Robotiq3FGripper_robot_output>))
  ...
  (rFRS m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Robotiq3FGripper_robot_output>) ostream)
  "Serializes a message object of type '<Robotiq3FGripper_robot_output>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Robotiq3FGripper_robot_output>) istream)
  "Deserializes a message object of type '<Robotiq3FGripper_robot_output>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Robotiq3FGripper_robot_output>)))
  "Returns string type for a message object of type '<Robotiq3FGripper_robot_output>"
  "robotiq_3f_gripper_control/Robotiq3FGripper_robot_output")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Robotiq3FGripper_robot_output)))
  "Returns string type for a message object of type 'Robotiq3FGripper_robot_output"
  "robotiq_3f_gripper_control/Robotiq3FGripper_robot_output")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Robotiq3FGripper_robot_output>)))
  "Returns md5sum for a message object of type '<Robotiq3FGripper_robot_output>"
  "31ba91390a569c669af204c3d006a806")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Robotiq3FGripper_robot_output)))
  "Returns md5sum for a message object of type 'Robotiq3FGripper_robot_output"
  "31ba91390a569c669af204c3d006a806")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Robotiq3FGripper_robot_output>)))
  "Returns full string definition for message of type '<Robotiq3FGripper_robot_output>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Robotiq3FGripper_robot_output)))
  "Returns full string definition for message of type 'Robotiq3FGripper_robot_output"
  (cl:format cl:nil "uint8 rACT ~%uint8 rMOD ~%uint8 rGTO ~%uint8 rATR ~%uint8 rGLV ~%uint8 rICF ~%uint8 rICS ~%uint8 rPRA ~%uint8 rSPA ~%uint8 rFRA ~%uint8 rPRB ~%uint8 rSPB ~%uint8 rFRB ~%uint8 rPRC ~%uint8 rSPC ~%uint8 rFRC ~%uint8 rPRS ~%uint8 rSPS ~%uint8 rFRS~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Robotiq3FGripper_robot_output>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Robotiq3FGripper_robot_output>))
  "Converts a ROS message object to a list"
  (cl:list 'Robotiq3FGripper_robot_output
